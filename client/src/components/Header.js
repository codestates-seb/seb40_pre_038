        ...
        {clickedMenu === 'help' ? (
          <HelpDropdown>
            ...
            <HelpDropdownSubContent>
              ...
              <span className="discription">Learn more about our products</span>
            </HelpDropdownSubContent>
          </HelpDropdown>
        ) : null}
        <CommunityIconContainer onClick={() => handleClickMenu('community')}>
          <svg
            aria-hidden="true"
        ...
        {clickedMenu === 'community' ? (
          <CommunityDropdown>
            ...
            <DropdownSubContent>
              ...
              <span className="discription loginout">Logout</span>
            </DropdownSubContent>
            <DropdownSubTitle>MORE STACK EXCHANGE COMMUNITIES</DropdownSubTitle>
            <DropdownSubContent>
