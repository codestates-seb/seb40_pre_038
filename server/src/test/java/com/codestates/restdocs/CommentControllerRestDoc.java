                ...
                .andDo(document(
                        ...
                        responseFields(
                                List.of(
                                        ...
                                        fieldWithPath("data.body").type(JsonFieldType.STRING).description("질문 댓글 본문"),
                ...
                .andDo(document("get-comments",
                        ...
                        responseFields(
                                List.of(
                                        ...
                                        fieldWithPath("pageInfo.totalElements").type(JsonFieldType.NUMBER).description("총 댓 수"),
